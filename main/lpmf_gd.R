...
test$Book.Rating <- (test$Book.Rating-1)/10
...
dim <- as.integer(dim)
print(dim)
load(paste0("~/nPMF/result/lpmf/mm-", dim, ".Rda"))
set.seed(123)
result <- lpmf_gd(train, dim, init, result$U, result$V, verbose = TRUE, batch = 180000)